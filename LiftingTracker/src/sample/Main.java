...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        mainPage.setStyle("-fx-background-color: #008080");
        ...
        maxesLayout.setStyle("-fx-background-color: #008080");
        ...
        newWorkoutLayout.setStyle("-fx-background-color: #008080");
        ...
        viewWorkoutsLayout.setStyle("-fx-background-color: #008080");
        ...
        viewWorkouts.setOnAction(e -> {
            ...
            viewWorkoutsLayout.getChildren().addAll(returnButton3, loadWorkouts, compareButton);
        ...
        helpLayout.setStyle("-fx-background-color: #008080");
        ...
        compareLayout.setStyle("-fx-background-color: #008080");
